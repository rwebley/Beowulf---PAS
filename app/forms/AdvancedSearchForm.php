...
->addFilter('StripTags')
->addFilter('StringTrim')
->addMultiOptions(array(NULL => NULL ,'Choose period from' => $periodword_options))->setDisableTranslator(true)
->setDecorators($decorators); 
...
->addFilter('StripTags')
->addFilter('StringTrim')
->setOptions(array('separator' => ''))->setDecorators($decorators); 
...
$this->addDisplayGroup(array('broadperiod','fromsubperiod','periodfrom','tosubperiod','periodto','culture','from','fromend','to','toend'), 'Temporaldetails')
->removeDecorator('HtmlTag');
...
$this->addDisplayGroup(array('county','regionID','district','parish','fourfigure','elevation','woeid'), 'Spatial')
->removeDecorator('HtmlTag');
...
if(in_array($this->getRole(),$this->restricted)) {
$this->addDisplayGroup(array('idby','identifierID','recordby','recorderID','createdAfter','createdBefore','discovered'), 'Discovery')->removeDecorator('HtmlTag');
} else {
$this->addDisplayGroup(array('finder','idby','identifierID','recordby','recorderID','createdAfter','createdBefore','discovered'), 'Discovery')->removeDecorator('HtmlTag');
}
