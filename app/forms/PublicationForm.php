...
$this->addDisplayGroup(array('title','authors','publisher','publication_place','publication_year','vol_no','edition','in_publication','editors','publication_type','ISBN'), 'details')->removeDecorator('HtmlTag');
