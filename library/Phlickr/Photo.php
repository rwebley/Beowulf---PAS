...
class Phlickr_Photo extends Phlickr_Framework_ObjectBase {
    ...
    */
    ...
    /**
     * Return the number of the farm where this photo is stored.
     *
     * @return  integer
     * @see     buildImgUrl()
     */
	...
	public function getGeo(){
	 $ret = array();
        ...
        foreach ($this->_cachedXml->location as $geo) {
            $ret[] = (string) $geo;
        }
        return $ret;
	...
	public function getCoords(){
		...
		$ret = array();
		$ret['lat'] = (float)$this->_cachedXml->location['latitude'];
		$ret['lon'] = (float)$this->_cachedXml->location['longitude'];
		$ret['woeid'] = (int)$this->_cachedXml->location['woeid'];
		$ret['accuracy'] = (int)$this->_cachedXml->location['accuracy'];
        $ret['context'] = (string)$this->_cachedXml->location['context'];
        return $ret; 
